class Game {
  ...
  start() {
    ...
    car1.addImage("carBadTime", blastImage);
    car1.scale = 0.07;

    car2 = createSprite(width / 2 + 100, height - 100);
    car2.addImage("car2", car2_img);
    car2.addImage("carBadTime", blastImage);
    car2.scale = 0.07;
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        if(currentLife <= 0){
          cars[index-1].changeImage("carBadTime");
